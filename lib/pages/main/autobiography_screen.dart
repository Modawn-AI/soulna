...
class _AutobiographyScreenState extends State<AutobiographyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: HeaderWidget.headerWithAction(
          context: context, title: showHeader == false ? '' : 'July 8'),
      body: Column(
        children: [
          if (showHeader == false)
            const SizedBox(
          ...
          Expanded(
            child: Container(
              color: ThemeSetting.of(context).common0.withOpacity(0.2),
                        ...
                        if (index == text.length - 1)
                          Column(
                            ...
                            children: [
                              ...
                              Center(
                                child: Text(
                                  LocaleKeys.share_my_ai_diary_to_your_friend
                                      .tr(),
